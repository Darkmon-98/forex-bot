...
if __name__ == "__main__":
    # إرسال رسالة ترحيبية فورية للتأكد من نجاح الاتصال بالتليجرام
    send_telegram_message("🤖 تم إعادة بناء وتشغيل بوت التداول المؤسسي (SMC) بنجاح على خادم الخلفية النظيف! جاري فحص الأسواق الآن...")
